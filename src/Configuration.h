...
#define STRING_CONFIG_H_AUTHOR "(yellowcub, Creality E3P BTT_SKR_mini_E3_v3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mortara E3P-1"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 37 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -12, -1.73 }
